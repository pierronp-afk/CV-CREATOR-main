    ...
    <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden animate-in zoom-in-95 duration-200 text-left">
      <div className="p-6 text-left">
        ...
        <div className="flex gap-3">
          ...
          <button 
            onClick={onConfirm} 
            className={`flex-1 px-4 py-3 text-white rounded-xl font-bold shadow-lg transition-colors ${danger ? 'bg-red-500 hover:bg-red-600 shadow-red-200' : 'bg-[#2E86C1] hover:bg-[#2573a7] shadow-blue-200'}`}
          >
            {confirmText}
          </button>
        </div>
